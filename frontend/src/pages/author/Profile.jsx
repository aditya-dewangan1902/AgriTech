...
import { User, ShieldAlert, Edit3, Save } from 'lucide-react';
...
const Profile = () => {
  ...
  const [profile, setProfile] = useState({
    firstName: 'L.',
    lastName: 'Rodriguez',
    institution: 'University of AgriTech',
    department: 'Department of Computer Science',
    email: 'l.rodriguez@agritech.edu',
    newPassword: '',
    confirmPassword: ''
  });
  ...
  const handleSave = (e) => {
    e.preventDefault();
    setIsEditing(false);
    // Display toast/alert in real app
  };
    ...
    <>
      <header className="mb-10 lg:pt-8">
        <h1 className="merriweather text-3xl font-bold text-[#222222] mb-1 flex items-center">
          <User className="w-7 h-7 mr-3 text-primary" /> Author Profile
        </h1>
        <p className="text-lg text-[#555555]">Manage your personal information, affiliation, and security settings.</p>
      </header>
